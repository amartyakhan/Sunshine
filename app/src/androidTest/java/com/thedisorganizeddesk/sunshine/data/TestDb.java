...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        assertTrue("ERROR: No record returned from the location table", c.moveToFirst());
        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("ERROR",c,contentValues);

        assertFalse("ERROR: There are more than one record in the location table",c.moveToNext());
    ...
    public void testWeatherTable() {
        ...
        assertTrue("ERROR: INSERT in location table FAILED",locationRowID!=-1);
        ...
        assertFalse("ERROR: There are more than one record in the weather table",c.moveToNext());
        // Finally, close the cursor and databases
        c.close();
        db.close();
