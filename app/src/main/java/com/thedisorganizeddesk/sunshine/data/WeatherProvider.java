 ...
 */
package com.thedisorganizeddesk.sunshine.data;
...
public class WeatherProvider extends ContentProvider {
    ...
    private Cursor getWeather(Uri uri, String[] projection,String selection, String[] selectionArgs, String sortOrder){
        SQLiteQueryBuilder sWeatherQueryBuiler;
        sWeatherQueryBuiler = new SQLiteQueryBuilder();

        //build the query for weather
        sWeatherQueryBuiler.setTables(WeatherContract.WeatherEntry.TABLE_NAME );
        return sWeatherQueryBuiler.query(mOpenHelper.getReadableDatabase(),projection,selection,selectionArgs,null,null,sortOrder);
    }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case WEATHER: {
                int rowCount = db.delete(WeatherContract.WeatherEntry.TABLE_NAME, selection, selectionArgs);
                returnVal=rowCount;
                break;
            }
            case LOCATION:{
                int rowCount=db.delete(WeatherContract.LocationEntry.TABLE_NAME, selection, selectionArgs);
                returnVal=rowCount;
                break;
            }
            default:
    ...
    public int update(
        ...
        switch (match) {
            case WEATHER: {
                int rowCount = db.update(WeatherContract.WeatherEntry.TABLE_NAME, values, selection, selectionArgs);
                returnVal=rowCount;
                break;
            }
            case LOCATION:{
                int rowCount=db.update(WeatherContract.LocationEntry.TABLE_NAME,values, selection, selectionArgs);
                returnVal=rowCount;
                break;
            }
            default:
